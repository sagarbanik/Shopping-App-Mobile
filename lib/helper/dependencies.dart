...
import 'package:shopping_app/data/repository/recommended_product_repo.dart';
...
Future<void> init() async {
  ...
  //Api Client
  Get.lazyPut(()=>ApiClient(preferences: Get.find(),appBaseUrl: Constants.BASE_URL));
  ...
  Get.lazyPut(() => LocationRepo(apiClient: Get.find(),preference: Get.find()));
  ...
  Get.lazyPut(() => LocationController(repo: Get.find()));
}